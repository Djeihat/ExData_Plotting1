# This fourth plot is composed of four graphss 
...
png(file="plot4.png")
par(mfrow=c(2,2))
plot(dates$Time,dates$GlobalActivePower,type="l",xlab="",ylab="Gobal Active Power (kilowatts)")
...
plot(dates$Time,dates$GlobalReactivePower,type="l",ylab="Global_reactive_power",xlab="datetime")
dev.off()